...
const expenseController_1 = require("../controller/expenseController/expenseController");
const imgUpload_1 = require("../middleware/imgUpload");
const router = (0, express_1.Router)();
router.post("/", auth_1.verifyUser, (0, checkPermission_1.default)('admin', 'ExpenseModel', 'can_create'), imgUpload_1.upload.array('documents', 10), (0, validate_dto_middleware_1.validateDto)(create_expense_dto_1.CreateExpenseDto), expenseController_1.expenseController.createExpense);
