...
router.post("/", auth_1.verifyUser, (0, checkPermission_1.default)('admin', 'PurchaseOrder', 'can_create'), imgUpload_1.upload.array('documents', 10), (0, validate_dto_middleware_1.validateDto)(billing_records_dto_1.CreateBillingRecordsDTO), billing_records_controller_1.default.createBillingRecords);
router.put("/:id", auth_1.verifyUser, (0, checkPermission_1.default)('admin', 'PurchaseOrder', 'can_update'), imgUpload_1.upload.array('documents', 10), (0, validate_dto_middleware_1.validateDto)(billing_records_dto_1.updateBillingRecordsDTO), billing_records_controller_1.default.updateBillingRecords);
